...
public class KotlinTypedHandler extends TypedHandlerDelegate {
    ...
    public Result beforeCharTyped(
        ...
        switch (c) {
            case ')':
                dataClassValParameterInsert(project, editor, file, /*afterType = */ true);
                break;
            case '<':
    ...
    public Result charTyped(char c, @NotNull Project project, @NotNull Editor editor, @NotNull PsiFile file) {
        ...
        if (kotlinLTTyped) {
            ...
            dataClassValParameterInsert(project, editor, file, /*afterType = */ false);
        }
    ...
    private static void dataClassValParameterInsert(@NotNull Project project, @NotNull Editor editor, @NotNull PsiFile file, boolean afterType) {
