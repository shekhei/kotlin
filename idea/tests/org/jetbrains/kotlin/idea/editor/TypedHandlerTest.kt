...
class TypedHandlerTest : LightCodeInsightTestCase() {
    ...
    fun testAutoAddValParameterToDataClass() {
        val editorOptions = KotlinEditorOptions.getInstance()
        val wasEnabled = editorOptions.isAutoAddValKeywordToDataClassParameters
        try {
            editorOptions.isAutoAddValKeywordToDataClassParameters = true

            doTypeTest(
                ',',
                """|class xxx(x: Int<caret>)""",
                """|class xxx(x: Int,<caret>)"""
            )
            ...
            doTypeTest(
                ',',
                """|data class xxx(x: Int /*comment*/ <caret>)""",
                """|data class xxx(val x: Int /*comment*/ ,<caret>)"""
            )

            doTypeTest(
                ',',
                """|data class xxx(x: Int = 2<caret>)""",
                """|data class xxx(val x: Int = 2,<caret>)"""
            )

            doTypeTest(
                ',',
                """|data class xxx(x = 2<caret>)""",
                """|data class xxx(x = 2,<caret>)"""
            )

            doTypeTest(
                ',',
                """|data class xxx(x: A<B><caret>)""",
                """|data class xxx(val x: A<B>,<caret>)"""
            )

            doTypeTest(
                ',',
                """|data class xxx(x<caret>)""",
                """|data class xxx(x,<caret>)"""
            )

            doTypeTest(
                ',',
                """|data class xxx(x: A<B,C<caret>)""",
                """|data class xxx(x: A<B,C,<caret>)"""
            )

            doTypeTest(
                ',',
                """|data class xxx(x:<caret> A<B>)""",
                """|data class xxx(x:,<caret> A<B>)"""
            )

            doTypeTest(
                ',',
                """|data class xxx(x: A><caret>)""",
                """|data class xxx(x: A>,<caret>)"""
            )
            ...
            doTypeTest(
                ')',
                """|data class xxx(val a: A, b: A<caret>)""",
                """|data class xxx(val a: A, val b: A)<caret>"""
            )

            doTypeTest(
                ')',
                """|inline class xxx(a: A<caret>)""",
                """|inline class xxx(val a: A)<caret>"""
            )
            ...
            editorOptions.isAutoAddValKeywordToDataClassParameters = false
            doTypeTest(
                ',',
                """|data class xxx(x: Int<caret>)""",
                """|data class xxx(x: Int,<caret>)"""
